...
import org.github.werehuman.tetris.impl.CurrentAction
import org.github.werehuman.tetris.impl.TetrisColor
import org.github.werehuman.tetris.impl.TetrisController
import java.awt.*
...
fun main(args: Array<String>) {
    ...
    val controller = TetrisController(10, 20, Duration.ofNanos(System.nanoTime()))
    ...
    frame.repaint()
    while (true) {
        val (duration, changed) = controller.proceed(Duration.ofNanos(System.nanoTime())) ?: break
        if (changed) {
            frame.repaint()
        }
